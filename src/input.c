...
static const char *wlf_cursor_names[35] = {
    [WLF_CURSOR_HIDDEN] = nullptr,
    [WLF_CURSOR_DEFAULT] = "default",
    [WLF_CURSOR_CONTEXT_MENU] = "context-menu",
    [WLF_CURSOR_HELP] = "help",
    [WLF_CURSOR_POINTER] = "pointer",
    [WLF_CURSOR_PROGRESS] = "progress",
    [WLF_CURSOR_WAIT] = "wait",
    [WLF_CURSOR_CELL] = "cell",
    [WLF_CURSOR_CROSSHAIR] = "crosshair",
    [WLF_CURSOR_TEXT] = "text",
    [WLF_CURSOR_VERTICAL_TEXT] = "vertical-text",
    [WLF_CURSOR_ALIAS] = "alias",
    [WLF_CURSOR_COPY] = "copy",
    [WLF_CURSOR_MOVE] = "move",
    [WLF_CURSOR_NO_DROP] = "no-drop",
    [WLF_CURSOR_NOT_ALLOWED] = "not-allowed",
    [WLF_CURSOR_GRAB] = "grab",
    [WLF_CURSOR_GRABBING] = "grabbing",
    [WLF_CURSOR_E_RESIZE] = "e-resize",
    [WLF_CURSOR_N_RESIZE] = "n-resize",
    [WLF_CURSOR_NE_RESIZE] = "ne-resize",
    [WLF_CURSOR_NW_RESIZE] = "nw-resize",
    [WLF_CURSOR_S_RESIZE] = "s-resize",
    [WLF_CURSOR_SE_RESIZE] = "se-resize",
    [WLF_CURSOR_SW_RESIZE] = "sw-resize",
    [WLF_CURSOR_W_RESIZE] = "w-resize",
    [WLF_CURSOR_EW_RESIZE] = "ew-resize",
    [WLF_CURSOR_NS_RESIZE] = "ns-resize",
    [WLF_CURSOR_NESW_RESIZE] = "nesw-resize",
    [WLF_CURSOR_NWSE_RESIZE] = "nwse-resize",
    [WLF_CURSOR_COL_RESIZE] = "col-resize",
    [WLF_CURSOR_ROW_RESIZE] = "row-resize",
    [WLF_CURSOR_ALL_SCROLL] = "all-scroll",
    [WLF_CURSOR_ZOOM_IN] = "zoom-in",
    [WLF_CURSOR_ZOOM_OUT] = "zoom-out",
};
